...
class Vcf2PrsWebServices(TestCase):
    ...
    def setUp(self):
        ...
        self.vcf_file = os.path.join(moduledir, "sample_data/sample_BCAC_313.vcf")
        self.vcf_data = open(self.vcf_file, "r")
        self.prs_file_name = os.path.join(moduledir, "sample_data/BCAC_313_PRS_info_file_2018-08-06.prs")
