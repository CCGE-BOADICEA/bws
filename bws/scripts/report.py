...
def wait_for_statfile(cls, fname="canrisk_report.pdf", max_time=10, time_interval=0.25):
...
def get_html(url, token, ows_result, bws_result):
    ...
    wait_for_statfile("/home/tim/Downloads/canrisk_report.pdf")
    os.remove(base)
    t.kill()
